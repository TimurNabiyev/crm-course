...
CREATE TABLE group_has_mentor (
	group_id BIGINT,
	mentor_id BIGINT NOT NULL,

	CONSTRAINT pk_group_mentor PRIMARY KEY(group_id, mentor_id),
	CONSTRAINT fk_group_mentor FOREIGN KEY(group_id) REFERENCES tb_groups(id),
	CONSTRAINT fk_mentor FOREIGN KEY(mentor_id) REFERENCES tb_mentors(id)
);



CREATE TABLE group_has_student (
	group_id BIGINT,
	student_id BIGINT,

	CONSTRAINT pk_group_student PRIMARY KEY(group_id, student_id),
	CONSTRAINT fk_group_student FOREIGN KEY(group_id) REFERENCES tb_groups(id),
